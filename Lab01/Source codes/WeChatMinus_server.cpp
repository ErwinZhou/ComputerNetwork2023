...
DWORD WINAPI RecvMessageThread(LPVOID lpParameter) {
	...
	str = "<WeChatMinus::Server @ " + string(str_time) + " # Notice>: " + "Welcome <" + username + "> join the ChatGroup!";//Server发言公告协议格式：
	//<WeChatMinus::Server @ Wed Oct 18 09:31:15 2023 # Notice>
	cout << str << endl;
	...
	if (redflag) {//对所有人发送公告
		...
		//<WeChatMinus::Server @ Wed Oct 18 09:31:15 2023 # Warning>
...
int main() {
	...
	//服务器等待
	cout << "Now let's wait......until someone knocks...." << endl;
	cout << "-----------Listening-----------" << endl;
